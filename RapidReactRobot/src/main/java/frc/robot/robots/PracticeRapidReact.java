...
public class PracticeRapidReact extends WaltRobot {
    ...
    private final double[][] lowGoalMap = {
            ...
            {0, 3.803, 0, 5100 + 100},
            {0, 6.105, 0.2, 6500 + 100},
            {0, 8.754, 0.4, 7500 + 100},
            {0, 9.037, 0.419, 7800 + 100},
            {0, 15.407, 0.85, 10050 + 100},
    };
...
//            {-1, 20.253874, 1.0, 13350},
            ...
            {-1, 7.051874, 0.4, 9205},
            {-1, 8.163874, 0.7, 9386},
            {-1, 8.979874, 0.75, 9583},
            {-1, 9.876874, 0.75, 9818},
            {-1, 10.961874, 0.75, 10278},
            {-1, 11.948874, 0.75, 10636},
            {-1, 12.873874, 0.75, 10922},
            {-1, 13.778874, 0.9, 11250},
            {-1, 14.951874, 1.0, 11649},
            {-1, 15.857874, 1.0, 11984},
            {-1, 16.678874, 1.0, 12274},
            {-1, 17.840874, 1.0, 12685},
            {-1, 19.388874, 1.0, 13295},
            {-1, 20.253874, 1.0, 13653},
    };
        ...
        drivetrainConfig = new DrivetrainConfig() {
            ...
            public PIDController[] getAzimuthPositionalPIDs() {
                return new PIDController[]{
                        ...
                        new PIDController(16.0 / 4096.0, 0.0, 0.0), // right front
